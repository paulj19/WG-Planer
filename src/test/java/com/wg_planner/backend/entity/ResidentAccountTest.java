...
public class ResidentAccountTest {
    ...
    public void ResidentAccount_ValidParameters_AccountCreatedAndReturned() {
        ...
        ResidentAccount residentAccount = new ResidentAccount("testValid_first_name", "testValid_last_name", "testValid@testCreate.com", "testValid_username", encoder.encode("testValid_password"), testRoom, authorities);
